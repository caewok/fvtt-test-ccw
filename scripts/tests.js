...
import { pointsEqual, compareXY } from "./utilities.js";
...
`);
  ...
  findIntersectionsBruteSingle(segments, reportFnBrute);
  findIntersectionsBruteSingle(segments, reportFnBruteFilterEndpoints);
  console.log(`Brute reports ${reporting_arr_brute.length} intersections; ${reporting_arr_brute_filtered.length} after filtering endpoint intersections.`);
