...
_$tinyqueue_7 = _$tinyqueue_7.exports
var _$pointInPolygonFlat_2 = function pointInPolygonFlat (point, vs, start, end) {
...
var _$pointInPolygonNested_4 = function pointInPolygonNested (point, vs, start, end) {
    var x = point[0], y = point[1];
    var inside = false;
    if (start === undefined) start = 0;
    if (end === undefined) end = vs.length;
...
export function concaveman(points, concavity, lengthThreshold) {
    ...
    var segTree = new _$rbushMin_5(16);
...
function findCandidate(tree, a, b, c, d, maxDist, segTree) {
    var queue = new _$tinyqueue_7([], compareDist);
    var node = tree.data;
...
function fastConvexHull(points) {
    ...
    for (i = 0; i < points.length; i++) {
        if (!_$pointInPolygon_3(points[i], cull)) filtered.push(points[i]);
    }
