...
function DEFAULT_COMPARE (a, b) { return a > b ? 1 : a < b ? -1 : 0; }
  ...
  export function boolean(subject, clipping, operation) {
  ...
  export function intersectionFn (subject, clipping) {
   ...
   * @enum {Number}
   */
  export var operations = { UNION: UNION, DIFFERENCE: DIFFERENCE, INTERSECTION: INTERSECTION, XOR: XOR };
