...
// let arr = Array.fromRange(1000).map(elem => Math.random())
// arr.sort((a, b) => a - b)
// for(let i = 0; i < 1000; i += 1) {
//   let n = Math.random();
//   let i0 = arr.findIndex(elem => elem > n) - 1;
//   let i1 = binaryFindIndex(arr, elem => elem > n) - 1
//   let i2 = interpolationFindIndexBeforeScalar(arr, n);
//   let i3 = interpolateBinaryFindIndexBeforeScalar(arr, n);
//   if(i0 !== i1) {
//     console.log(`binaryFindIndex Fail at ${n}`)
//     break;
//   }
//   if(i0 !== i2) {
//     // may be different at the very end of the array: elem > n not same as elem < n && arr[idx + 1] > n
//     console.log(`interpolateFindIndex Fail at ${n}`)
//     break;
//   }
//   if(i0 !== i3) {
//     console.log(`interpolateBinaryFindIndex Fail at ${n}`)
//     break;
//   }
// }
...
export function interpolateBinaryIndexOf(arr, x) {
  ...
  while(left < right) {
    ...
    } else { //if(x < arr[inter]) { // if(x < arr[inter])
...
//   let n = Math.random();
//   let i1 = binaryFindIndex(arr, elem => elem > n) - 1
//   let i2 = interpolateBinaryFindIndexBeforeScalar(arr, n);
//   if(i1 !== i2) {
//     console.log(`Fail at ${n}`)
//     break;
//   }
// }
...
// export function interpolateBinaryFindIndexAfterObject(arr, obj, valuationFn = (a) => a) {
//   let left = 0;
//   let right = arr.length - 1;
//   const x = valuationFn(obj);
//
...
//     const v_inter = valuationFn(arr[inter])
//
//     if(x === v_inter) {  // use while loop to walk forward/backward based on whether this is before or after?
//       return inter - 1;
//     } else if(x > v_inter) {
//       const mid = Math.floor((inter + right) / 2)
//       if(x <= valuationFn(arr[mid])) {
