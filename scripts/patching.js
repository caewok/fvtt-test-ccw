...
export function registerCCW() {
  libWrapper.register(MODULE_ID, 'RadialSweepPolygon.prototype._initializeEndpoints', testCCWInitializeEndpoints, 'MIXED', {perf.mode = libWrapper.PERF_FAST});
  libWrapper.register(MODULE_ID, 'RadialSweepPolygon.prototype._sweepEndpoints', testCCWSweepEndpoints, 'MIXED', {perf.mode = libWrapper.PERF_FAST});
  libWrapper.register(MODULE_ID, 'RadialSweepPolygon.prototype._includeWall', testCCWIncludeWall, 'MIXED', {perf.mode = libWrapper.PERF_FAST});
  libWrapper.register(MODULE_ID, 'RadialSweepPolygon.prototype._constructPoints', testCCWConstructPoints, 'MIXED', {perf.mode = libWrapper.PERF_FAST});
}
